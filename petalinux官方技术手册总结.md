...
2、\$ petalinux-package --bsp -p \<plnx-proj-root\> --output MY_BPS

\<plnx-proj-root\> ：为petalinux工程目录位置
...
（192.168.3.1/24表示连接指定的ip和端口，

192.168.3.\*表示192.168.3下的任意设备）
...
同时把image.ub放到/tftpboot目录下

把rootfs.tar.gz解压到/home/peta18/share
